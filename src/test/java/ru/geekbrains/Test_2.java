...
public class Test_2 {
    ...
    public static void main(String[] args)  {
        ...
        // Ввод в поле "Имя"
        driver.findElement(By.xpath("//div[1]/div[2]/div[2]/input[@name='crm_contact[firstName]']")).sendKeys("Иван");

        // Кликаем на менюшку "Организация" и выбираем "kolobok"
        ...
        driver.findElement(By.xpath("//div[2]/div[2]/input[@name='crm_contact[jobTitle]']")).sendKeys("Лесоруб");
